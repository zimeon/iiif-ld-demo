...
g.add((c1, exif.height, Literal(3000, datatype=XSD.integer)))
g.add((c1, exif.width, Literal(2000, datatype=XSD.integer)))
...
g.add((c2, exif.height, Literal(3000, datatype=XSD.integer)))
